...
function ABE_CDMCustomBarMixin:GetCustomAuraColor()
    if not self.spellID then return end
...
function ABE_CDMCustomBarMixin:GetBarDisplayType()
    if not self.spellID then return end
...
function ABE_CDMCustomBarMixin:RefreshBackdrop()
    ABE_CDMCustomItemMixin.RefreshBackdrop(self)
...
function ABE_CDMCustomBarMixin:RefreshVisibility()
    ...
    ABE_CDMCustomItemMixin.RefreshVisibility(self)
end
...
function ABE_CDMCustomBarMixin:RefreshSpellTexture()
...
function ABE_CDMCustomBarMixin:OnAuraDone()

    ABE_CDMCustomItemMixin.OnAuraDone(self)
    --[[ if not self.isOnActualCooldown then
        self:OnCooldownDone()
    end ]]
end

function ABE_CDMCustomBarMixin:ShouldShowAura()
    return self.barDisplayType and self.barDisplayType > 1
end

function ABE_CDMCustomBarMixin:ShouldShowCooldown()
...
function ABE_CDMCustomBarMixin:RefreshSpellName()
...
function ABE_CDMCustomBarMixin:GetSpellName()
...
function ABE_CDMCustomBarMixin:GetStatusbar()
    return self.Bar
end

function ABE_CDMCustomBarMixin:RefreshIconDesaturation(desaturated)
    
end

--[[ function ABE_CDMCustomBarMixin:ConfigureAuraContainer(auraButton)
...
function ABE_CDMCustomBarFrameMixin:OnAcquireItemFrame(itemFrame)
    ABE_CDMCustomFrameMixin.OnAcquireItemFrame(self, itemFrame)
